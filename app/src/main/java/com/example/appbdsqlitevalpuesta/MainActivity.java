...
public class MainActivity extends AppCompatActivity { //Inicia clase
    ...
    public void altaProducto(View view) { //Inicia metodo alta producto
    ...
    } //Termina metodo alta producto

    public void consultaProducto(View view){ //Inicia metodo consulta campo distintivo
        AdminSQLiteOpenHelper admin = new AdminSQLiteOpenHelper(this, "administracion", null, 1);
        SQLiteDatabase bd = admin.getWritableDatabase();//objetos de base de datos se reescribible
    ...
    } //Termina metodo consulta campo distintivo

    public void eliminarProducto(View view){ //Inicia metodo eliminar producto
        AdminSQLiteOpenHelper admin = new AdminSQLiteOpenHelper(this, "administracion", null, 1);
    ...
    } //Termina metodo eliminar producto

    public void modificarProductos(View view){ //Inicia metodo modificar producto
        AdminSQLiteOpenHelper admin = new AdminSQLiteOpenHelper(this, "administracion", null, 1);
        SQLiteDatabase bd = admin.getWritableDatabase();//objetos de base de datos  reescribible
    ...
    } //Inicia metodo modificar producto
